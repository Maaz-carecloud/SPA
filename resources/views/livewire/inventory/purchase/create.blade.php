<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Create a new product purchase entry</p>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initializeSelect2() {
                if (isSelect2Initialized) return; // Initialize Select2 for suppliers
                $('#product_supplier_id').select2({
                    ...
                    @this.set('product_supplier_id', value);
                ...
                $('#product_warehouse_id').select2({
                    ...
                    @this.set('product_warehouse_id', value);
                ...
                // Initialize Select2 for products (dynamic)        initializeProductSelect2();
            ...
            function destroySelect2() {
                console.log('Destroying Select2 instances');
