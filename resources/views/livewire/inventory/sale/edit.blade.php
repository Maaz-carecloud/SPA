<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Update sale information and items</p>
        </div>
        <a href="{{ route('sales') }}" wire:navigate class="btn btn-outline-secondary">
        ...
        <div class="row">
                                ...
                                @if ($sale->sale_slip)
                                    <div class="mt-2">
                                        <small class="text-muted">Current file:
                                            <a href="{{ Storage::url($sale->sale_slip) }}" target="_blank">View File</a>
                                        </small>
                                    </div>
                                @endif
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card bgs-card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="payment_status" class="form-label">Payment Status *</label> <select
                                id="payment_status" wire:model="payment_status"
