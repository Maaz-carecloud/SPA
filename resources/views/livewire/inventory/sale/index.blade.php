<x-sections.default>
    ...
    @php
        $columns = ['#', 'Reference No', 'Customer', 'Sale Date', 'Grand Total', 'Total Paid', 'Balance', 'Payment Status', 'Action'];
    @endphp
    <livewire:data-table :columns="$columns" table-id="salesTable" ajax-url="/datatable/sales" :key="microtime(true)" />
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Payment Management - {{ $selectedSale->reference_no }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <strong>Customer:</strong> {{ $selectedSale->user->name ?? 'N/A' }}<br>
                                    <strong>Sale Date:</strong> {{ $selectedSale->sale_date }}<br>
                                </div>
                                <div class="col-md-6">
                                    @php
                                        $subtotal = $selectedSale->items->sum(function($item) {
