<div>
                        ...
                        <div class="ms-2">
                            @forelse($modulePermissions as $permission)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="edit_perm_{{ $permission->id }}" value="{{ $permission->id }}" wire:model="selectedPermissions">
    ...
    @else
        <div class="text-center py-4">
            <p class="text-muted">No role selected for editing.</p>
        </div>
    @endif
</div>
