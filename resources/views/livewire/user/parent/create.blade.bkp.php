        ...
        <div class="col-lg-12">
            <div class="card bgs-card shadow border-0 mt-4">
                <div class="card-header d-flex align-items-center">
                    <h5 class="mb-0">Parent User Information</h5>
                </div>
                <div class="card-body p-4">
                    <form wire:submit.prevent="nextStep">
                        ...
                        <input type="hidden" wire:model="user_type" value="parent">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-4">
                                <label for="user_is_active" class="form-label">Active Status</label>
        ...
        <div class="col-lg-12">
            <div class="card bgs-card shadow border-0 mt-4">
                <div class="card-header">
                    <h5 class="mb-0">Parent Additional Information</h5>
                </div>
                <div class="card-body p-4">
                    <form wire:submit.prevent="createParent">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="father_profession" wire:model.lazy="father_profession" class="form-control @error('father_profession') is-invalid @enderror" placeholder="Enter father's profession">
                                @error('father_profession') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="mother_name" class="form-label">Mother's Name</label>
                                <input type="text" id="mother_name" wire:model.lazy="mother_name" class="form-control @error('mother_name') is-invalid @enderror" placeholder="Enter mother's name">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="mother_contact" wire:model.lazy="mother_contact" class="form-control @error('mother_contact') is-invalid @enderror" placeholder="Enter mother's contact">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="mother_profession" wire:model.lazy="mother_profession" class="form-control @error('mother_profession') is-invalid @enderror" placeholder="Enter mother's profession">
                                @error('mother_profession') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                <label for="ntn_no" class="form-label">NTN No</label>
                                <input type="text" id="ntn_no" wire:model.lazy="ntn_no" class="form-control @error('ntn_no') is-invalid @enderror" placeholder="Enter NTN number">
                                @error('ntn_no') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-success px-4 py-2">Create Parent</button>
                        </div>
                    </form>
                </div>
            </div>
