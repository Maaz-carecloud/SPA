<div wire:ignore.self>
    <x-form.modal id="createParentModal" title="Create New Parent" size="modal-xl" backdrop="static" wireCloseMethod="closeModal">
        <div>
            <form wire:submit.prevent="createParent">
                ...
                <x-slot name="footer">
                    ...
                    <button type="submit" class="btn theme-filled-btn" wire:click='createParent'>Create Parent</button>
                </x-slot>
            </form>
        </div>
    </x-form.modal>
