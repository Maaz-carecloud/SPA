<div>
    @if($step === 1)
    <!-- Step 1: Only validates user fields, does NOT insert user. Data is saved only after step 2. -->
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card bgs-card shadow border-0 mt-4">
                <div class="card-header d-flex align-items-center">
                    <h5 class="mb-0">Student User Information</h5>
                </div>
                    ...
                    <form wire:submit.prevent="nextStep">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="user_religion" wire:model.lazy="user_religion" class="form-control @error('user_religion') is-invalid @enderror" placeholder="Enter religion">
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="user_cnic" wire:model.lazy="user_cnic" class="form-control @error('user_cnic') is-invalid @enderror" placeholder="Enter CNIC">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="user_blood_group" wire:model.lazy="user_blood_group" class="form-control @error('user_blood_group') is-invalid @enderror" placeholder="Enter blood group">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="user_registration_no" wire:model.lazy="user_registration_no" class="form-control @error('user_registration_no') is-invalid @enderror" placeholder="Enter registration no">
                                @error('user_registration_no') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-8">
                                <label for="user_address" class="form-label">Address</label>
                                <input type="text" id="user_address" wire:model.lazy="user_address" class="form-control @error('user_address') is-invalid @enderror" placeholder="Enter address">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="user_country" wire:model.lazy="user_country" class="form-control @error('user_country') is-invalid @enderror" placeholder="Enter country">
                                @error('user_country') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-4">
                                <label for="user_city" class="form-label">City</label>
                                <input type="text" id="user_city" wire:model.lazy="user_city" class="form-control @error('user_city') is-invalid @enderror" placeholder="Enter city">
                                @error('user_city') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-4">
                                <label for="user_state" class="form-label">State</label>
                                <input type="text" id="user_state" wire:model.lazy="user_state" class="form-control @error('user_state') is-invalid @enderror" placeholder="Enter state">
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="user_transport_id" wire:model.lazy="user_transport_id" class="form-control @error('user_transport_id') is-invalid @enderror" placeholder="Enter transport id">
                                @error('user_transport_id') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="row g-3 mt-2">
                            <div class="col-md-3">
                                <label for="user_is_active" class="form-label">Is Active</label>
    ...
    @endif
    @if($step === 2)
    <!-- Step 2: Submits all data (user + student) to the database. -->
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card bgs-card shadow border-0 mt-4">
                <div class="card-header">
                    <h5 class="mb-0">Student Academic Information</h5>
                </div>
                <div class="card-body p-4">
                    <form wire:submit.prevent="createStudent">
                        <div class="row g-3">
                            <div class="col-md-12 mb-2">
                                ...
                                <select id="parent_id" wire:model.lazy="parent_id" class="form-control @error('parent_id') is-invalid @enderror">
                                    <option value="">Select Parent</option>
                                    @foreach($parents as $parent)
                                        <option value="{{ $parent->id }}">{{ $parent->user->name ?? 'N/A' }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" id="admission_date" wire:model.lazy="admission_date" class="form-control @error('admission_date') is-invalid @enderror">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="roll_no" wire:model.lazy="roll_no" class="form-control @error('roll_no') is-invalid @enderror" placeholder="Enter roll number">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                ...
                                <select id="class_id" wire:model.lazy="class_id" class="form-control @error('class_id') is-invalid @enderror">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="section_id" wire:model.lazy="section_id" class="form-control @error('section_id') is-invalid @enderror">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                <div class="form-check mt-4">
                                    <input type="checkbox" id="library_status" wire:model.lazy="library_status" value="1" class="form-check-input">
                                    <label for="library_status" class="form-check-label">Library Active</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check mt-4">
                                    <input type="checkbox" id="hostel_status" wire:model.lazy="hostel_status" value="1" class="form-check-input">
                                    <label for="hostel_status" class="form-check-label">Hostel Active</label>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn btn-secondary px-4 py-2" wire:click="$set('step', 1)"><i class="bi bi-arrow-left"></i> Back</button>
                            <button type="submit" class="btn btn-success px-4 py-2">Create Student</button>
                        </div>
                    </form>
                </div>
            </div>
