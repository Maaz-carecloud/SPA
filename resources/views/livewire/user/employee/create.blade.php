<div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card bgs-card border-0">
                <div class="card-header d-flex align-items-center">
                    <h5 class="theme-title">Employee User Information</h5>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="nextStep">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit" class="btn theme-unfilled-btn px-4 py-2">Next <i class="bi bi-arrow-right"></i></button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="card bgs-card border-0">
                <div class="card-header">
                    <h5 class="theme-title">Employee Job Information</h5>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="createEmployee">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn theme-unfilled-btn px-4 py-2" wire:click="prevStep"><i class="bi bi-arrow-left"></i> Previous</button>
                            <button type="submit" class="btn theme-filled-btn px-4 py-2">Save</button>
                        </div>
                    </form>
                </div>
            </div>
