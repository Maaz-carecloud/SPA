                                ...
                                <select wire:model.live="library_member_id" 
                                    ...
                                    @foreach($libraryMembers as $member)
                                        <option value="{{ $member->id }}">
                                            {{ $member->name }} - ID: {{ $member->id }} - {{ $member->library_id }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                @if($selectedMember)
                                    <div class="mt-2 p-2 bg-light rounded">
                                        <small class="text-muted">
                                            ...
                                            (Member ID: {{ $selectedMember->id }}, Library ID: {{ $selectedMember->library_id }})
                                        </small>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    @if(is_null($return_date))
                                        <span class="badge bg-warning me-2">Not Returned</span>
                                        <button type="button" 
                                    ...
                                    @else
                                        <span class="badge bg-success">
                                            ...
                                            Returned on {{ \Carbon\Carbon::parse($return_date)->format('M d, Y') }}
                                        </span>
                                    @endif
                                </div>
                            </div>
